                    ...
                    Row(
                      ...
                      children: [
                        const ImageOverlayWidget(
                            title: 'messenger', provider: AssetImage('assets/icons/messenger.png'), heightFactor: 0.08, widthFactor: 0.08, boarderRadius: 0, boarderStatus: false),
                        SizedBox(width: screenWidth * 0.04),
                        const ImageOverlayWidget(
                            title: 'messenger', provider: AssetImage('assets/icons/telephone_call.png'), heightFactor: 0.08, widthFactor: 0.08, boarderRadius: 0, boarderStatus: false),
                        SizedBox(width: screenWidth * 0.04),
                        const ImageOverlayWidget(
                            title: 'messenger', provider: AssetImage('assets/icons/telegram.png'), heightFactor: 0.08, widthFactor: 0.08, boarderRadius: 0, boarderStatus: false)
                      ],
                    )
                  ],
                ),
